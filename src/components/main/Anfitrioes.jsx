        ...
        <div className='anfitrioes--presentation' id='anfitrioes'>
            <div id="myAnfitrioes" className="carousel slide anfitrioes--slide--show" data-ride="carousel">
                <ol className="carousel-indicators">
                    ...
                    <li data-target="#myAnfitrioes" data-slide-to="1"></li>
                    <li data-target="#myAnfitrioes" data-slide-to="2"></li>
                    <li data-target="#myAnfitrioes" data-slide-to="3"></li>
                </ol>
                ...
                <div className="carousel-inner">
                    ...
                    <div className="item">
                        <img className='img--anfitrioes' src={image2} alt="Morro de São Paulo" />
                        <div className="carousel-caption">
                            <h3>Morro de São Paulo</h3>
                    ...
                    <div className="item">
                        <img className='img--anfitrioes' src={image3} alt="Morro de São Paulo" />
                        <div className="carousel-caption">
                            <h3>Morro de São Paulo</h3>
                    ...
                    <div className="item">
                        <img className='img--anfitrioes' src={image4} alt="Morro de São Paulo" />
                        <div className="carousel-caption">
                            <h3>Morro de São Paulo</h3>
                            <p>We love the Big Apple!</p>
                        </div>
